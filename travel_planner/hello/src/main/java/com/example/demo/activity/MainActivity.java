...
import com.example.demo.fragment.BookingFragment;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private int res_img_normal[] = {R.drawable.icon_shouye_nor, R.drawable.icon_shouye_nor, R.drawable.icon_wo_nor};
    private int res_img_selected[] = {R.drawable.icon_shouye_hig, R.drawable.icon_shouye_hig, R.drawable.icon_wo_hig};
    private TextView tv[];
    ...
    private void initViews() {
        ...
        mFragments[1] = BookingFragment.newInstance("Book");
    ...
    private void tabSelected(int index) {
        for (int i = 0; i < res_img_normal.length; i++) {
            ...
            tv[i].setTextColor(getResources().getColor(R.color.color_333333));
        }
        img[index].setImageResource(res_img_selected[index]);
        tv[index].setTextColor(getResources().getColor(R.color.colorPrimary));
        showFragment(index);
    }
